...
const EDGES: CausalEdge[] = [
  ...
  { id: "t1d_e9", source: "t1d_cgm_tir", target: "t1d_dkd", weight: -0.6, lag: 36, type: "temporal", confidence: 0.8, isInconsistent: false, physicalMechanism: "Glycemic exposure drives mesangial matrix expansion over years", weightSourceRef: "dcct-1993", confidenceSourceRef: "dcct-1993" },
  { id: "t1d_e10", source: "t1d_cgm_tir", target: "t1d_retinopathy", weight: -0.55, lag: 24, type: "temporal", confidence: 0.8, isInconsistent: false, physicalMechanism: "Hyperglycemia-driven microvascular damage accumulates", weightSourceRef: "dcct-1993", confidenceSourceRef: "dcct-1993" },
  ...
  { id: "t1d_e16", source: "t1d_population_hba1c", target: "t1d_dkd", weight: 0.7, lag: 60, type: "temporal", confidence: 0.9, isInconsistent: false, physicalMechanism: "Each 1% HbA1c rise ~1.3× DKD progression risk (DCCT/EDIC legacy)", weightSourceRef: "edic-legacy", confidenceSourceRef: "edic-legacy" },
  { id: "t1d_e17", source: "t1d_population_hba1c", target: "t1d_retinopathy", weight: 0.65, lag: 48, type: "temporal", confidence: 0.9, isInconsistent: false, physicalMechanism: "Cumulative glycemic exposure drives microvascular damage (DCCT)", weightSourceRef: "edic-legacy", confidenceSourceRef: "edic-legacy" },
  { id: "t1d_e18", source: "t1d_realworld_tir", target: "t1d_population_hba1c", weight: -0.8, lag: 2, type: "temporal", confidence: 0.95, isInconsistent: false, physicalMechanism: "TIR % and HbA1c are mathematically coupled via time-averaged glucose (Vigersky/Battelino 2019)", weightSourceRef: "vigersky-2019", confidenceSourceRef: "vigersky-2019" },
  ...
  // Interventions
  { id: "t1d_e11", source: "t1d_teplizumab", target: "t1d_cd8_teff", weight: -0.6, lag: 0, type: "directed", confidence: 0.8, isInconsistent: false, physicalMechanism: "anti-CD3 induces partial T-cell anergy / exhaustion", weightSourceRef: "perdigoto-stm-2021", confidenceSourceRef: "perdigoto-stm-2021" },
  { id: "t1d_e12", source: "t1d_teplizumab", target: "t1d_c_peptide", weight: 0.3, lag: 12, type: "temporal", confidence: 0.7, isInconsistent: false, physicalMechanism: "Delayed β-cell loss preserves endogenous insulin", weightSourceRef: "herold-nejm-2019", confidenceSourceRef: "herold-nejm-2019" },
  { id: "t1d_e13", source: "t1d_stem_cell_beta", target: "t1d_beta_mass", weight: 0.7, lag: 6, type: "temporal", confidence: 0.5, isInconsistent: false, physicalMechanism: "Exogenous β-cell engraftment restores functional mass (subject to immune rejection)", weightSourceRef: "reichman-nejm-2025", confidenceSourceRef: "reichman-nejm-2025" },
