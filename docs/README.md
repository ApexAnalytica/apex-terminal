...
| [`SECURITY.md`](./SECURITY.md) | Trust boundaries, current findings, positive observations for customer reviews, conventions for new code, audit log. | You are triaging a vulnerability, adding a new API route, prepping a customer security review, or running a security audit. |
