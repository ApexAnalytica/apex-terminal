...
export const HEADER_MAP: Record<string, string> = {
  ...
  // Lisa workbook aliases — Food Security (Category 5)
  company_anchor: "label",
  import_dependency_percent: "composite",
  key_imports: "physicalConstraint",
  main_suppliers: "globalConcentration",
  strategic_reserves_months: "replacementTime",
  subsidy_program: "physicalConstraint",
  food_share_of_spending_percent: "composite",
  global_wheat_price_usd_per_ton: "composite",
  fertilizer_price_index: "composite",
  shipping_cost_index: "composite",
  currency_change_yoy_percent: "composite",
  food_price_inflation_percent: "composite",
  // Lisa workbook aliases — Undersea Cables (Category 6)
  cable_name: "label",
  capacity_tbps: "physicalConstraint",
  landing_points: "globalConcentration",
  owners_operators: "globalConcentration",
  year_operational: "replacementTime",
  redundancy: "physicalConstraint",
  red_sea_exposure_score: "composite",
  reroute_stress_index: "composite",
  latency_risk_ms_proxy: "composite",
  repair_complexity_score: "composite",
  incident_flag: "isConfounded",
  incident_note: "physicalConstraint",
  landing_point: "label",
  cable_system: "domain",
  entity_type: "category",
  subtype: "category",
  geography: "domain",
  route_or_role: "physicalConstraint",
  metric_name: "label",
