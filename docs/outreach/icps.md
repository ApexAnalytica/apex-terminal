# Apex Analytica — ICP Playbook

**Audience:** Referral partners (Thibaut Perney, Kai Crayford, future BD partners), internal team.
...
- Chief Innovation Officer / Head of Strategy and Technology (if it's an internal-tool play)
...
When introducing a prospect at any of the above, lead with **structural causality under climate non-stationarity** as the value proposition. Do *not* lead with the engines or ΩF framework — those land on the second call. First-touch language:
...
- **US:** JPMorgan, Goldman Sachs, Morgan Stanley, Citigroup, Bank of America, Wells Fargo (treasury-side mostly).
- **EU:** Deutsche Bank, BNP Paribas, Barclays, Santander, ING, UBS, Credit Agricole, BBVA, Société Générale.
- **APAC:** HSBC, Standard Chartered, Mitsubishi UFJ (MUFG), Mizuho, Sumitomo Mitsui (SMBC), DBS, OCBC, Nomura.
...
Lead with **FRTB / structural counterparty methodology** as the value proposition. First-touch:
...
Lead with **regime detection and structural causality** as the value proposition. First-touch:
...
**Buyers.** Treasury macro offices, central-bank research divisions (separate from financial-stability — research-side is slower but receptive), NGO and think-tank macro researchers, sovereign wealth funds with macro mandate.
...
The pipeline updates from your debriefs. The ICP doc evolves from what you learn. Both of those are how the playbook gets sharper over time.
