...
export const CANONICAL_FIELDS: { group: string; fields: { value: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { value: "irreplaceability", label: "Irreplaceability" },
      { value: "restorationLatency", label: "Restoration Latency" },
      { value: "jurisdictionalHazard", label: "Jurisdictional Hazard" },
      { value: "cascadeLoad", label: "Cascade Load" },
      { value: "tailDepth", label: "Tail Depth" },
