...
**This Referral Partner Agreement** (the "**Agreement**") is entered into as of **the latest signature date below** (the "**Effective Date**") by and between:
...
**THIBAUT PERNEY** ("**Referrer**"), an individual.
...
**2.1. First-Year Commission.** Apex shall pay Referrer **fifteen percent (15%)** of the Annual Contract Value ("**ACV**") of any Qualifying Deal (as defined in Section 3), based on revenue actually collected by Apex from the customer in the first contract year.
...
**2.5. Illustrative Calculation.** *For illustration only:* a Qualifying Deal at the Enterprise tier with $150,000 ACV would generate the following commissions to Referrer, assuming full collection in each year:
...
(e) Any Prospect for whom another active referral partner of Apex has, prior to Referrer's introduction, made a documented introduction to Apex (as recorded on Apex's pipeline list referenced in Section 3.1(b)). In the event of overlap, attribution is determined under Section 3.2.
...
**9.6. Assignment.** Neither Party may assign this Agreement without the prior written consent of the other Party, except that Apex may assign this Agreement in connection with a merger, acquisition, reorganization, or sale of substantially all of its assets.
